...
export class OrganizationsComponent implements OnInit {
  ...
  dataSource: OrgListDataSource | null;
  displayedColumns = ['checkbox', 'name', 'owner', 'location', 'total_size', 'max_size'];
  ...
  constructor( private orgListService: OrganizationListService, private snackBar: MatSnackBar, public dialog: MatDialog) { }
  ...
  ngOnInit() {
    ...
    this.dataSource = new OrgListDataSource(this.orgListService, this.paginator, this.sort);
  ...
  deleteSelected() {
    this.selection.selected.forEach(org => {
        this.orgListService.deleteOrg(org).then(() => {
            this.selection.clear();
...
export class OrgListDataSource extends DataSource<any> {
  ...
  constructor(
      private dataService: OrganizationListService,
  ...
  connect(): Observable<any[]> {
    ...
    //       let data = this.orgListService.orgList.slice();
    ...
    return Observable.merge(...displayDataChanges).pipe(switchMap(() => {
        return this.dataService.getOrganizations().pipe(switchMap(data => {
